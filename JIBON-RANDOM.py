...
def rcrack1(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
         ...
         # 'cookie': 'datr=9ot1ZBUIQEDKwUu903LxvbDi; sb=9ot1ZG7SCCz7Wq1ohRt8eCBK; m_pixel_ratio=2; wd=980x1835; fr=0IDfOGF3qQI3EcaAu..BkdYv2.Qc.AAA.0.0.BkdYyr.AWVWi16IOjA',
